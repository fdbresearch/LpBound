DROP TABLE IF EXISTS norms_groupby;
CREATE TABLE norms_groupby (
...
DROP TABLE IF EXISTS groupby_domain_sizes;
CREATE TABLE groupby_domain_sizes (
    relation_name TEXT NOT NULL,
    aggregator_name TEXT NOT NULL,
    groupby_vars_name TEXT NOT NULL,
    pred_col_name TEXT,
...
SELECT
    CAST_INFO.MOVIE_ID AS MOVIE_ID, CAST_INFO.NR_ORDER AS NR_ORDER, CAST_INFO.PERSON_ID AS PERSON_ID, CAST_INFO.PERSON_ROLE_ID AS PERSON_ROLE_ID, CAST_INFO.ROLE_ID AS ROLE_ID,
...
SELECT
    CAST_INFO.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(CAST_INFO.ROLE_ID)) AS deg
FROM CAST_INFO

WHERE CAST_INFO.MOVIE_ID IS NOT NULL
GROUP BY
    CAST_INFO.MOVIE_ID
HAVING COUNT(DISTINCT(CAST_INFO.ROLE_ID)) > 0
ORDER BY deg DESC
;
...
INSERT INTO groupby_domain_sizes BY NAME 
    ...
    NULL AS pk_relation_name,
    NULL AS pk_join_var_name,
    COUNT(DISTINCT(ROLE_ID)) AS domain_size,
        FROM
            CAST_INFO AS R
;
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                CAST_INFO.ROLE_ID AS non_mcv_value,
                CAST_INFO.ROLE_ID AS ROLE_ID
            FROM CAST_INFO
            LEFT JOIN CAST_INFO_ROLE_ID_mcv mcvt ON CAST_INFO.ROLE_ID = mcvt.ROLE_ID
...
SELECT
    mcvt.mcv_id AS mcv_id,
    CAST_INFO_MOVIE_ID_ID_TITLE.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(CAST_INFO_MOVIE_ID_ID_TITLE.ROLE_ID)) AS deg
FROM CAST_INFO_MOVIE_ID_ID_TITLE
JOIN TITLE_KIND_ID_mcv mcvt ON CAST_INFO_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
WHERE CAST_INFO_MOVIE_ID_ID_TITLE.MOVIE_ID IS NOT NULL
GROUP BY
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        filtered_table AS (
            SELECT
                mcvt.mcv_id AS mcv_id,
                CAST_INFO_MOVIE_ID_ID_TITLE.ROLE_ID AS ROLE_ID
            FROM CAST_INFO_MOVIE_ID_ID_TITLE
            JOIN TITLE_KIND_ID_mcv mcvt ON CAST_INFO_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
        )
        SELECT
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                CAST_INFO_MOVIE_ID_ID_TITLE.TITLE_KIND_ID AS non_mcv_value,
                CAST_INFO_MOVIE_ID_ID_TITLE.ROLE_ID AS ROLE_ID
            FROM CAST_INFO_MOVIE_ID_ID_TITLE
            LEFT JOIN TITLE_KIND_ID_mcv mcvt ON CAST_INFO_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
            WHERE mcvt.mcv_id IS NULL
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                CAST_INFO_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR AS non_mcv_value,
                CAST_INFO_MOVIE_ID_ID_TITLE.ROLE_ID AS ROLE_ID
            FROM CAST_INFO_MOVIE_ID_ID_TITLE
            LEFT JOIN TITLE_PRODUCTION_YEAR_mcv mcvt ON CAST_INFO_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR = mcvt.PRODUCTION_YEAR
            WHERE mcvt.mcv_id IS NULL
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        table_with_buckets AS  (
            SELECT
                H.bucket_id AS bucket_id,
                CAST_INFO_MOVIE_ID_ID_TITLE.ROLE_ID AS ROLE_ID
            FROM CAST_INFO_MOVIE_ID_ID_TITLE
            JOIN TITLE_PRODUCTION_YEAR_histogram H ON 
                (H.lower_bound IS NULL OR CAST_INFO_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR >= H.lower_bound)
                AND (H.upper_bound IS NULL OR CAST_INFO_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR <= H.upper_bound)
        )
        SELECT
            'CAST_INFO' AS relation_name,
    'ROLE_ID' AS groupby_vars_name,
...
SELECT
    CAST_INFO.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(CAST_INFO.PERSON_ID)) AS deg
FROM CAST_INFO

WHERE CAST_INFO.MOVIE_ID IS NOT NULL
GROUP BY
    CAST_INFO.MOVIE_ID
HAVING COUNT(DISTINCT(CAST_INFO.PERSON_ID)) > 0
ORDER BY deg DESC
;
...
SELECT
    ...
    'NOPRED' AS aggregator_name,
    NULL AS pred_col_name,
    'PERSON_ID' AS groupby_vars_name,
    1 AS pred_value_id,
  COUNT(*) AS l0,
  SUM(POWER(deg, 1)) AS l1,
  SUM(POWER(deg, 2)) AS l2,
...
INSERT INTO groupby_domain_sizes BY NAME 
    ...
    NULL AS pk_relation_name,
    NULL AS pk_join_var_name,
    COUNT(DISTINCT(PERSON_ID)) AS domain_size,
        FROM
            CAST_INFO AS R
;
...
SELECT
    mcvt.mcv_id AS mcv_id,
    CAST_INFO_MOVIE_ID_ID_TITLE.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(CAST_INFO_MOVIE_ID_ID_TITLE.PERSON_ID)) AS deg
FROM CAST_INFO_MOVIE_ID_ID_TITLE
JOIN TITLE_KIND_ID_mcv mcvt ON CAST_INFO_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
WHERE CAST_INFO_MOVIE_ID_ID_TITLE.MOVIE_ID IS NOT NULL
GROUP BY
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        filtered_table AS (
            SELECT
                mcvt.mcv_id AS mcv_id,
                CAST_INFO_MOVIE_ID_ID_TITLE.PERSON_ID AS PERSON_ID
            FROM CAST_INFO_MOVIE_ID_ID_TITLE
            JOIN TITLE_KIND_ID_mcv mcvt ON CAST_INFO_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
        )
        SELECT
...
SELECT
    CAST_INFO.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(CAST_INFO.NR_ORDER)) AS deg
FROM CAST_INFO

WHERE CAST_INFO.MOVIE_ID IS NOT NULL
GROUP BY
    CAST_INFO.MOVIE_ID
HAVING COUNT(DISTINCT(CAST_INFO.NR_ORDER)) > 0
ORDER BY deg DESC
;
...
INSERT INTO groupby_domain_sizes BY NAME 
    ...
    NULL AS pk_relation_name,
    NULL AS pk_join_var_name,
    COUNT(DISTINCT(NR_ORDER)) AS domain_size,
        FROM
            CAST_INFO AS R
;
...
SELECT
    mcvt.mcv_id AS mcv_id,
    CAST_INFO_MOVIE_ID_ID_TITLE.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(CAST_INFO_MOVIE_ID_ID_TITLE.NR_ORDER)) AS deg
FROM CAST_INFO_MOVIE_ID_ID_TITLE
JOIN TITLE_KIND_ID_mcv mcvt ON CAST_INFO_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
WHERE CAST_INFO_MOVIE_ID_ID_TITLE.MOVIE_ID IS NOT NULL
GROUP BY
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        filtered_table AS (
            SELECT
                mcvt.mcv_id AS mcv_id,
                CAST_INFO_MOVIE_ID_ID_TITLE.NR_ORDER AS NR_ORDER
            FROM CAST_INFO_MOVIE_ID_ID_TITLE
            JOIN TITLE_KIND_ID_mcv mcvt ON CAST_INFO_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
        )
        SELECT
...
SELECT
    CAST_INFO.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(CAST_INFO.PERSON_ROLE_ID)) AS deg
FROM CAST_INFO

WHERE CAST_INFO.MOVIE_ID IS NOT NULL
GROUP BY
    CAST_INFO.MOVIE_ID
HAVING COUNT(DISTINCT(CAST_INFO.PERSON_ROLE_ID)) > 0
ORDER BY deg DESC
;
...
SELECT
    ...
    'NOPRED' AS aggregator_name,
    NULL AS pred_col_name,
    'PERSON_ROLE_ID' AS groupby_vars_name,
    1 AS pred_value_id,
  COUNT(*) AS l0,
  SUM(POWER(deg, 1)) AS l1,
  SUM(POWER(deg, 2)) AS l2,
...
INSERT INTO groupby_domain_sizes BY NAME 
    ...
    NULL AS pk_relation_name,
    NULL AS pk_join_var_name,
    COUNT(DISTINCT(PERSON_ROLE_ID)) AS domain_size,
        FROM
            CAST_INFO AS R
;
...
SELECT
    mcvt.mcv_id AS mcv_id,
    CAST_INFO_MOVIE_ID_ID_TITLE.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(CAST_INFO_MOVIE_ID_ID_TITLE.PERSON_ROLE_ID)) AS deg
FROM CAST_INFO_MOVIE_ID_ID_TITLE
JOIN TITLE_KIND_ID_mcv mcvt ON CAST_INFO_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
WHERE CAST_INFO_MOVIE_ID_ID_TITLE.MOVIE_ID IS NOT NULL
GROUP BY
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        filtered_table AS (
            SELECT
                mcvt.mcv_id AS mcv_id,
                CAST_INFO_MOVIE_ID_ID_TITLE.PERSON_ROLE_ID AS PERSON_ROLE_ID
            FROM CAST_INFO_MOVIE_ID_ID_TITLE
            JOIN TITLE_KIND_ID_mcv mcvt ON CAST_INFO_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
        )
        SELECT
...
SELECT
    MOVIE_COMPANIES.MOVIE_ID AS MOVIE_ID, MOVIE_COMPANIES.COMPANY_ID AS COMPANY_ID, MOVIE_COMPANIES.COMPANY_TYPE_ID AS COMPANY_TYPE_ID,
    TITLE.PRODUCTION_YEAR AS TITLE_PRODUCTION_YEAR, TITLE.KIND_ID AS TITLE_KIND_ID
FROM MOVIE_COMPANIES
JOIN TITLE
...
SELECT
    MOVIE_COMPANIES.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(MOVIE_COMPANIES.COMPANY_TYPE_ID)) AS deg
FROM MOVIE_COMPANIES

WHERE MOVIE_COMPANIES.MOVIE_ID IS NOT NULL
GROUP BY
    MOVIE_COMPANIES.MOVIE_ID
HAVING COUNT(DISTINCT(MOVIE_COMPANIES.COMPANY_TYPE_ID)) > 0
ORDER BY deg DESC
;
...
SELECT
    ...
    'NOPRED' AS aggregator_name,
    NULL AS pred_col_name,
    'COMPANY_TYPE_ID' AS groupby_vars_name,
    1 AS pred_value_id,
  COUNT(*) AS l0,
  SUM(POWER(deg, 1)) AS l1,
  SUM(POWER(deg, 2)) AS l2,
...
INSERT INTO groupby_domain_sizes BY NAME 
    ...
    NULL AS pk_relation_name,
    NULL AS pk_join_var_name,
    COUNT(DISTINCT(COMPANY_TYPE_ID)) AS domain_size,
        FROM
            MOVIE_COMPANIES AS R
;
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                MOVIE_COMPANIES.COMPANY_ID AS non_mcv_value,
                MOVIE_COMPANIES.COMPANY_TYPE_ID AS COMPANY_TYPE_ID
            FROM MOVIE_COMPANIES
            LEFT JOIN MOVIE_COMPANIES_COMPANY_ID_mcv mcvt ON MOVIE_COMPANIES.COMPANY_ID = mcvt.COMPANY_ID
            WHERE mcvt.mcv_id IS NULL
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                MOVIE_COMPANIES.COMPANY_TYPE_ID AS non_mcv_value,
                MOVIE_COMPANIES.COMPANY_TYPE_ID AS COMPANY_TYPE_ID
            FROM MOVIE_COMPANIES
            LEFT JOIN MOVIE_COMPANIES_COMPANY_TYPE_ID_mcv mcvt ON MOVIE_COMPANIES.COMPANY_TYPE_ID = mcvt.COMPANY_TYPE_ID
            WHERE mcvt.mcv_id IS NULL
...
SELECT
    mcvt.mcv_id AS mcv_id,
    MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.COMPANY_TYPE_ID)) AS deg
FROM MOVIE_COMPANIES_MOVIE_ID_ID_TITLE
JOIN TITLE_KIND_ID_mcv mcvt ON MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
WHERE MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.MOVIE_ID IS NOT NULL
GROUP BY
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        filtered_table AS (
            SELECT
                mcvt.mcv_id AS mcv_id,
                MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.COMPANY_TYPE_ID AS COMPANY_TYPE_ID
            FROM MOVIE_COMPANIES_MOVIE_ID_ID_TITLE
            JOIN TITLE_KIND_ID_mcv mcvt ON MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
        )
        SELECT
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.TITLE_KIND_ID AS non_mcv_value,
                MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.COMPANY_TYPE_ID AS COMPANY_TYPE_ID
            FROM MOVIE_COMPANIES_MOVIE_ID_ID_TITLE
            LEFT JOIN TITLE_KIND_ID_mcv mcvt ON MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
            WHERE mcvt.mcv_id IS NULL
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR AS non_mcv_value,
                MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.COMPANY_TYPE_ID AS COMPANY_TYPE_ID
            FROM MOVIE_COMPANIES_MOVIE_ID_ID_TITLE
            LEFT JOIN TITLE_PRODUCTION_YEAR_mcv mcvt ON MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR = mcvt.PRODUCTION_YEAR
            WHERE mcvt.mcv_id IS NULL
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        table_with_buckets AS  (
            ...
            FROM MOVIE_COMPANIES_MOVIE_ID_ID_TITLE
            JOIN TITLE_PRODUCTION_YEAR_histogram H ON 
                (H.lower_bound IS NULL OR MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR >= H.lower_bound)
                AND (H.upper_bound IS NULL OR MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR <= H.upper_bound)
        )
        SELECT
            'MOVIE_COMPANIES' AS relation_name,
    'COMPANY_TYPE_ID' AS groupby_vars_name,
...
SELECT
    MOVIE_COMPANIES.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(MOVIE_COMPANIES.COMPANY_ID)) AS deg
FROM MOVIE_COMPANIES

WHERE MOVIE_COMPANIES.MOVIE_ID IS NOT NULL
GROUP BY
    MOVIE_COMPANIES.MOVIE_ID
HAVING COUNT(DISTINCT(MOVIE_COMPANIES.COMPANY_ID)) > 0
ORDER BY deg DESC
;
...
SELECT
    ...
    'NOPRED' AS aggregator_name,
    NULL AS pred_col_name,
    'COMPANY_ID' AS groupby_vars_name,
    1 AS pred_value_id,
  COUNT(*) AS l0,
  SUM(POWER(deg, 1)) AS l1,
  SUM(POWER(deg, 2)) AS l2,
...
INSERT INTO groupby_domain_sizes BY NAME 
    ...
    NULL AS pk_relation_name,
    NULL AS pk_join_var_name,
    COUNT(DISTINCT(COMPANY_ID)) AS domain_size,
        FROM
            MOVIE_COMPANIES AS R
;
...
SELECT
    mcvt.mcv_id AS mcv_id,
    MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.COMPANY_ID)) AS deg
FROM MOVIE_COMPANIES_MOVIE_ID_ID_TITLE
JOIN TITLE_KIND_ID_mcv mcvt ON MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
WHERE MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.MOVIE_ID IS NOT NULL
GROUP BY
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        filtered_table AS (
            SELECT
                mcvt.mcv_id AS mcv_id,
                MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.COMPANY_ID AS COMPANY_ID
            FROM MOVIE_COMPANIES_MOVIE_ID_ID_TITLE
            JOIN TITLE_KIND_ID_mcv mcvt ON MOVIE_COMPANIES_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
        )
        SELECT
...
SELECT
    MOVIE_INFO_IDX.MOVIE_ID AS MOVIE_ID, MOVIE_INFO_IDX.INFO_TYPE_ID AS INFO_TYPE_ID,
    TITLE.PRODUCTION_YEAR AS TITLE_PRODUCTION_YEAR, TITLE.KIND_ID AS TITLE_KIND_ID
FROM MOVIE_INFO_IDX
JOIN TITLE
...
SELECT
    MOVIE_INFO_IDX.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(MOVIE_INFO_IDX.INFO_TYPE_ID)) AS deg
FROM MOVIE_INFO_IDX

WHERE MOVIE_INFO_IDX.MOVIE_ID IS NOT NULL
GROUP BY
    MOVIE_INFO_IDX.MOVIE_ID
HAVING COUNT(DISTINCT(MOVIE_INFO_IDX.INFO_TYPE_ID)) > 0
ORDER BY deg DESC
;
...
SELECT
    ...
    'NOPRED' AS aggregator_name,
    NULL AS pred_col_name,
    'INFO_TYPE_ID' AS groupby_vars_name,
    1 AS pred_value_id,
  COUNT(*) AS l0,
  SUM(POWER(deg, 1)) AS l1,
  SUM(POWER(deg, 2)) AS l2,
...
INSERT INTO groupby_domain_sizes BY NAME 
    ...
    NULL AS pk_relation_name,
    NULL AS pk_join_var_name,
    COUNT(DISTINCT(INFO_TYPE_ID)) AS domain_size,
        FROM
            MOVIE_INFO_IDX AS R
;
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                MOVIE_INFO_IDX.INFO_TYPE_ID AS non_mcv_value,
                MOVIE_INFO_IDX.INFO_TYPE_ID AS INFO_TYPE_ID
            FROM MOVIE_INFO_IDX
            LEFT JOIN MOVIE_INFO_IDX_INFO_TYPE_ID_mcv mcvt ON MOVIE_INFO_IDX.INFO_TYPE_ID = mcvt.INFO_TYPE_ID
            WHERE mcvt.mcv_id IS NULL
...
SELECT
    mcvt.mcv_id AS mcv_id,
    MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE.INFO_TYPE_ID)) AS deg
FROM MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE
JOIN TITLE_KIND_ID_mcv mcvt ON MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
WHERE MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE.MOVIE_ID IS NOT NULL
GROUP BY
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        filtered_table AS (
            SELECT
                mcvt.mcv_id AS mcv_id,
                MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE.INFO_TYPE_ID AS INFO_TYPE_ID
            FROM MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE
            JOIN TITLE_KIND_ID_mcv mcvt ON MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
        )
        SELECT
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE.TITLE_KIND_ID AS non_mcv_value,
                MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE.INFO_TYPE_ID AS INFO_TYPE_ID
            FROM MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE
            LEFT JOIN TITLE_KIND_ID_mcv mcvt ON MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
            WHERE mcvt.mcv_id IS NULL
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR AS non_mcv_value,
                MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE.INFO_TYPE_ID AS INFO_TYPE_ID
            FROM MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE
            LEFT JOIN TITLE_PRODUCTION_YEAR_mcv mcvt ON MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR = mcvt.PRODUCTION_YEAR
            WHERE mcvt.mcv_id IS NULL
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        table_with_buckets AS  (
            ...
            FROM MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE
            JOIN TITLE_PRODUCTION_YEAR_histogram H ON 
                (H.lower_bound IS NULL OR MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR >= H.lower_bound)
                AND (H.upper_bound IS NULL OR MOVIE_INFO_IDX_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR <= H.upper_bound)
        )
        SELECT
            'MOVIE_INFO_IDX' AS relation_name,
    'INFO_TYPE_ID' AS groupby_vars_name,
...
SELECT
    MOVIE_KEYWORD.MOVIE_ID AS MOVIE_ID, MOVIE_KEYWORD.KEYWORD_ID AS KEYWORD_ID,
    TITLE.PRODUCTION_YEAR AS TITLE_PRODUCTION_YEAR, TITLE.KIND_ID AS TITLE_KIND_ID
FROM MOVIE_KEYWORD
JOIN TITLE
...
SELECT
    MOVIE_KEYWORD.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(MOVIE_KEYWORD.KEYWORD_ID)) AS deg
FROM MOVIE_KEYWORD

WHERE MOVIE_KEYWORD.MOVIE_ID IS NOT NULL
GROUP BY
    MOVIE_KEYWORD.MOVIE_ID
HAVING COUNT(DISTINCT(MOVIE_KEYWORD.KEYWORD_ID)) > 0
ORDER BY deg DESC
;
...
SELECT
    ...
    'NOPRED' AS aggregator_name,
    NULL AS pred_col_name,
    'KEYWORD_ID' AS groupby_vars_name,
    1 AS pred_value_id,
  COUNT(*) AS l0,
  SUM(POWER(deg, 1)) AS l1,
  SUM(POWER(deg, 2)) AS l2,
...
INSERT INTO groupby_domain_sizes BY NAME 
    ...
    NULL AS pk_relation_name,
    NULL AS pk_join_var_name,
    COUNT(DISTINCT(KEYWORD_ID)) AS domain_size,
        FROM
            MOVIE_KEYWORD AS R
;
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                MOVIE_KEYWORD.KEYWORD_ID AS non_mcv_value,
                MOVIE_KEYWORD.KEYWORD_ID AS KEYWORD_ID
            FROM MOVIE_KEYWORD
            LEFT JOIN MOVIE_KEYWORD_KEYWORD_ID_mcv mcvt ON MOVIE_KEYWORD.KEYWORD_ID = mcvt.KEYWORD_ID
            WHERE mcvt.mcv_id IS NULL
...
SELECT
    mcvt.mcv_id AS mcv_id,
    MOVIE_KEYWORD_MOVIE_ID_ID_TITLE.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(MOVIE_KEYWORD_MOVIE_ID_ID_TITLE.KEYWORD_ID)) AS deg
FROM MOVIE_KEYWORD_MOVIE_ID_ID_TITLE
JOIN TITLE_KIND_ID_mcv mcvt ON MOVIE_KEYWORD_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
WHERE MOVIE_KEYWORD_MOVIE_ID_ID_TITLE.MOVIE_ID IS NOT NULL
GROUP BY
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        filtered_table AS (
            SELECT
                mcvt.mcv_id AS mcv_id,
                MOVIE_KEYWORD_MOVIE_ID_ID_TITLE.KEYWORD_ID AS KEYWORD_ID
            FROM MOVIE_KEYWORD_MOVIE_ID_ID_TITLE
            JOIN TITLE_KIND_ID_mcv mcvt ON MOVIE_KEYWORD_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
        )
        SELECT
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                MOVIE_KEYWORD_MOVIE_ID_ID_TITLE.TITLE_KIND_ID AS non_mcv_value,
                MOVIE_KEYWORD_MOVIE_ID_ID_TITLE.KEYWORD_ID AS KEYWORD_ID
            FROM MOVIE_KEYWORD_MOVIE_ID_ID_TITLE
            LEFT JOIN TITLE_KIND_ID_mcv mcvt ON MOVIE_KEYWORD_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
            WHERE mcvt.mcv_id IS NULL
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                MOVIE_KEYWORD_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR AS non_mcv_value,
                MOVIE_KEYWORD_MOVIE_ID_ID_TITLE.KEYWORD_ID AS KEYWORD_ID
            FROM MOVIE_KEYWORD_MOVIE_ID_ID_TITLE
            LEFT JOIN TITLE_PRODUCTION_YEAR_mcv mcvt ON MOVIE_KEYWORD_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR = mcvt.PRODUCTION_YEAR
            WHERE mcvt.mcv_id IS NULL
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        table_with_buckets AS  (
            ...
            FROM MOVIE_KEYWORD_MOVIE_ID_ID_TITLE
            JOIN TITLE_PRODUCTION_YEAR_histogram H ON 
                (H.lower_bound IS NULL OR MOVIE_KEYWORD_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR >= H.lower_bound)
                AND (H.upper_bound IS NULL OR MOVIE_KEYWORD_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR <= H.upper_bound)
        )
        SELECT
            'MOVIE_KEYWORD' AS relation_name,
    'KEYWORD_ID' AS groupby_vars_name,
...
SELECT
    TITLE.ID AS ID,
    COUNT(DISTINCT(TITLE.PRODUCTION_YEAR)) AS deg
FROM TITLE

WHERE TITLE.ID IS NOT NULL
GROUP BY
    TITLE.ID
HAVING COUNT(DISTINCT(TITLE.PRODUCTION_YEAR)) > 0
ORDER BY deg DESC
;
...
SELECT
    ...
    'NOPRED' AS aggregator_name,
    NULL AS pred_col_name,
    'PRODUCTION_YEAR' AS groupby_vars_name,
    1 AS pred_value_id,
  COUNT(*) AS l0,
  SUM(POWER(deg, 1)) AS l1,
  SUM(POWER(deg, 2)) AS l2,
...
INSERT INTO groupby_domain_sizes BY NAME 
    ...
    NULL AS pk_relation_name,
    NULL AS pk_join_var_name,
    COUNT(DISTINCT(PRODUCTION_YEAR)) AS domain_size,
        FROM
            TITLE AS R
;
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                TITLE.KIND_ID AS non_mcv_value,
                TITLE.PRODUCTION_YEAR AS PRODUCTION_YEAR
            FROM TITLE
            LEFT JOIN TITLE_KIND_ID_mcv mcvt ON TITLE.KIND_ID = mcvt.KIND_ID
            WHERE mcvt.mcv_id IS NULL
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                TITLE.PRODUCTION_YEAR AS non_mcv_value,
                TITLE.PRODUCTION_YEAR AS PRODUCTION_YEAR
            FROM TITLE
            LEFT JOIN TITLE_PRODUCTION_YEAR_mcv mcvt ON TITLE.PRODUCTION_YEAR = mcvt.PRODUCTION_YEAR
            WHERE mcvt.mcv_id IS NULL
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        table_with_buckets AS  (
            ...
            FROM TITLE
            JOIN TITLE_PRODUCTION_YEAR_histogram H ON 
                (H.lower_bound IS NULL OR TITLE.PRODUCTION_YEAR >= H.lower_bound)
                AND (H.upper_bound IS NULL OR TITLE.PRODUCTION_YEAR <= H.upper_bound)
        )
        SELECT
            'TITLE' AS relation_name,
    'PRODUCTION_YEAR' AS groupby_vars_name,
...
SELECT
    TITLE.ID AS ID,
    COUNT(DISTINCT(TITLE.KIND_ID)) AS deg
FROM TITLE

WHERE TITLE.ID IS NOT NULL
GROUP BY
    TITLE.ID
HAVING COUNT(DISTINCT(TITLE.KIND_ID)) > 0
ORDER BY deg DESC
;
...
INSERT INTO groupby_domain_sizes BY NAME 
    ...
    NULL AS pk_relation_name,
    NULL AS pk_join_var_name,
    COUNT(DISTINCT(KIND_ID)) AS domain_size,
        FROM
            TITLE AS R
;
...
SELECT
    TITLE.ID AS ID,
    COUNT(DISTINCT(TITLE.SEASON_NR)) AS deg
FROM TITLE

WHERE TITLE.ID IS NOT NULL
GROUP BY
    TITLE.ID
HAVING COUNT(DISTINCT(TITLE.SEASON_NR)) > 0
ORDER BY deg DESC
;
...
SELECT
    ...
    'NOPRED' AS aggregator_name,
    NULL AS pred_col_name,
    'SEASON_NR' AS groupby_vars_name,
    1 AS pred_value_id,
  COUNT(*) AS l0,
  SUM(POWER(deg, 1)) AS l1,
  SUM(POWER(deg, 2)) AS l2,
...
INSERT INTO groupby_domain_sizes BY NAME 
    ...
    NULL AS pk_relation_name,
    NULL AS pk_join_var_name,
    COUNT(DISTINCT(SEASON_NR)) AS domain_size,
        FROM
            TITLE AS R
;
...
SELECT
    TITLE.ID AS ID,
    COUNT(DISTINCT(TITLE.EPISODE_OF_ID)) AS deg
FROM TITLE

WHERE TITLE.ID IS NOT NULL
GROUP BY
    TITLE.ID
HAVING COUNT(DISTINCT(TITLE.EPISODE_OF_ID)) > 0
ORDER BY deg DESC
;
...
SELECT
    ...
    'NOPRED' AS aggregator_name,
    NULL AS pred_col_name,
    'EPISODE_OF_ID' AS groupby_vars_name,
    1 AS pred_value_id,
  COUNT(*) AS l0,
  SUM(POWER(deg, 1)) AS l1,
  SUM(POWER(deg, 2)) AS l2,
...
INSERT INTO groupby_domain_sizes BY NAME 
    ...
    NULL AS pk_relation_name,
    NULL AS pk_join_var_name,
    COUNT(DISTINCT(EPISODE_OF_ID)) AS domain_size,
        FROM
            TITLE AS R
;
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        filtered_table AS (
            SELECT
                mcvt.mcv_id AS mcv_id,
                TITLE.EPISODE_OF_ID AS EPISODE_OF_ID
            FROM TITLE
            JOIN TITLE_KIND_ID_mcv mcvt ON TITLE.KIND_ID = mcvt.KIND_ID
        )
        SELECT
...
SELECT
    MOVIE_INFO.MOVIE_ID AS MOVIE_ID, MOVIE_INFO.INFO_TYPE_ID AS INFO_TYPE_ID,
    TITLE.PRODUCTION_YEAR AS TITLE_PRODUCTION_YEAR, TITLE.KIND_ID AS TITLE_KIND_ID
FROM MOVIE_INFO
JOIN TITLE
...
SELECT
    MOVIE_INFO.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(MOVIE_INFO.INFO_TYPE_ID)) AS deg
FROM MOVIE_INFO

WHERE MOVIE_INFO.MOVIE_ID IS NOT NULL
GROUP BY
    MOVIE_INFO.MOVIE_ID
HAVING COUNT(DISTINCT(MOVIE_INFO.INFO_TYPE_ID)) > 0
ORDER BY deg DESC
;
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                MOVIE_INFO.INFO_TYPE_ID AS non_mcv_value,
                MOVIE_INFO.INFO_TYPE_ID AS INFO_TYPE_ID
            FROM MOVIE_INFO
            LEFT JOIN MOVIE_INFO_INFO_TYPE_ID_mcv mcvt ON MOVIE_INFO.INFO_TYPE_ID = mcvt.INFO_TYPE_ID
            WHERE mcvt.mcv_id IS NULL
...
SELECT
    mcvt.mcv_id AS mcv_id,
    MOVIE_INFO_MOVIE_ID_ID_TITLE.MOVIE_ID AS MOVIE_ID,
    COUNT(DISTINCT(MOVIE_INFO_MOVIE_ID_ID_TITLE.INFO_TYPE_ID)) AS deg
FROM MOVIE_INFO_MOVIE_ID_ID_TITLE
JOIN TITLE_KIND_ID_mcv mcvt ON MOVIE_INFO_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
WHERE MOVIE_INFO_MOVIE_ID_ID_TITLE.MOVIE_ID IS NOT NULL
GROUP BY
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        filtered_table AS (
            SELECT
                mcvt.mcv_id AS mcv_id,
                MOVIE_INFO_MOVIE_ID_ID_TITLE.INFO_TYPE_ID AS INFO_TYPE_ID
            FROM MOVIE_INFO_MOVIE_ID_ID_TITLE
            JOIN TITLE_KIND_ID_mcv mcvt ON MOVIE_INFO_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
        )
        SELECT
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                MOVIE_INFO_MOVIE_ID_ID_TITLE.TITLE_KIND_ID AS non_mcv_value,
                MOVIE_INFO_MOVIE_ID_ID_TITLE.INFO_TYPE_ID AS INFO_TYPE_ID
            FROM MOVIE_INFO_MOVIE_ID_ID_TITLE
            LEFT JOIN TITLE_KIND_ID_mcv mcvt ON MOVIE_INFO_MOVIE_ID_ID_TITLE.TITLE_KIND_ID = mcvt.KIND_ID
            WHERE mcvt.mcv_id IS NULL
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        non_mcv_table AS (
            SELECT
                MOVIE_INFO_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR AS non_mcv_value,
                MOVIE_INFO_MOVIE_ID_ID_TITLE.INFO_TYPE_ID AS INFO_TYPE_ID
            FROM MOVIE_INFO_MOVIE_ID_ID_TITLE
            LEFT JOIN TITLE_PRODUCTION_YEAR_mcv mcvt ON MOVIE_INFO_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR = mcvt.PRODUCTION_YEAR
            WHERE mcvt.mcv_id IS NULL
...
INSERT INTO groupby_domain_sizes BY NAME 
    WITH
        table_with_buckets AS  (
            ...
            FROM MOVIE_INFO_MOVIE_ID_ID_TITLE
            JOIN TITLE_PRODUCTION_YEAR_histogram H ON 
                (H.lower_bound IS NULL OR MOVIE_INFO_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR >= H.lower_bound)
                AND (H.upper_bound IS NULL OR MOVIE_INFO_MOVIE_ID_ID_TITLE.TITLE_PRODUCTION_YEAR <= H.upper_bound)
        )
        SELECT
            'MOVIE_INFO' AS relation_name,
    'INFO_TYPE_ID' AS groupby_vars_name,
